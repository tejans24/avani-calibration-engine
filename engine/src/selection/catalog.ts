...
export const PROVISIONS: readonly Provision[] = [
  // Plugins
  {
    ...
    description: 'Universal, language-agnostic standards: accessibility, security, git workflow, testing discipline, code review, orchestration discipline, stage detection.',
