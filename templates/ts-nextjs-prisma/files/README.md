...
Generated by the [Avani Calibration Engine](https://github.com/tejans24/avani-calibration-engine). The stack: Next.js (App Router) + Prisma + Postgres 18, Tailwind, Clerk (pre-wired, optional), TypeScript strict, Zod at every boundary.
